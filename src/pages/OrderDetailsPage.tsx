                    ...
                    <div className="col-lg-10 col-xl-12 m-lr-auto m-b-50">
                        ...
                        <div className="wrap-table-shopping-cart">
                            ...
                            <tbody>
                                ...
                                <th className="column-1">Ürün ID</th>
                                <th className="column-2">Ürün Adı</th>
                                <th className="column-3">Adet</th>
                                <th className="column-4">Toplam Fiyat</th>
                                <th className="column-5">Birim Fiyat</th>
                                </tr>
                                {orderDetails && orderDetails.map((order, idx) => (
                                    <tr className="table_row" key={`${order.orderID}-${idx}`}>
                                        {/* <td className="column-1">
                                            <div className="how-itemcart1">
                                                <img src="images/item-cart-04.jpg" alt="IMG" />
                                            </div>
                                        </td> */}
                                        <td className="column-1">{order.productID} </td>
                                        <td className="column-2">{order.productName} </td>
                                        <td className="column-3">
                                            {order.quantity}
                                            {/* <div className="wrap-num-product flex-w m-l-auto m-r-0">
                                                <div className="btn-num-product-down cl
                                            {/* {order.productName} */}
                                            {/* <div className="wrap-num-product flex-w m-l-auto m-r-0">
                                        ...
                                        <td className="column-4">{order.totalPrice}</td>
                                        <td className="column-5">{order.unitPrice}</td>
                                    </tr>
                                    ))}
